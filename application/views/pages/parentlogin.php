		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="fright mr10">
					<a role="button" class="btn btn-danger" href="<?php echo base_url();?>index.php/Pages/loginHome">
				...
				<div class="col-md-4 h250">
					<div class="panel panel-default">
						...
						<div class="panel-body">
						 <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/Pages/goToEdit" method="post">
						<?php
