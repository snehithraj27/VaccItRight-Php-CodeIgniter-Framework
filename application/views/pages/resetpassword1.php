...
$result=$db->query($query);
	...
	redirect('/index.php/Pages/resetPassword2','refresh');
                     ...
                     <div class="container-fluid">
                        <div class="row">
                              <h2 class="text-center" style="color: #204d74;"> <strong> RESET PASSWORD  </strong></h2><hr />
							    ...
							    <form class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/Pages/resetPassword1" method="post">
